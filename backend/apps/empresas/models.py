...
class Empresa(models.Model):
    ...
    def save(self, *args, **kwargs):
        # RFC siempre en mayúsculas (normalización fiscal).
        self.rfc = (self.rfc or '').strip().upper()
        # `direccion` es un campo derivado: se arma con las partes si existen.
...
class Obra(models.Model):
    ...
    # ── Domicilio de la obra (estructurado) ──
