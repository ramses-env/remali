      ...
      <div className="contenedor py-16">
        ...
        <div className="pt-8 border-t border-edge flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <a href="https://www.instagram.com/remali.mx" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="p-2 rounded-full border border-edge hover:border-gold hover:text-gold-ink transition-colors">
            ...
            <a href="https://www.facebook.com/share/17zvByPJMn/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="p-2 rounded-full border border-edge hover:border-gold hover:text-gold-ink transition-colors">
