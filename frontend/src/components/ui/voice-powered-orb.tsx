...
export const VoicePoweredOrb: FC<VoicePoweredOrbProps> = ({
  ...
  useEffect(() => {
    ...
    let glContext: (import('ogl').OGLRenderingContext & { canvas: HTMLCanvasElement }) | null = null;
    let rafId: number;
    ...
    try {
      ...
      glContext = rendererInstance.gl as import('ogl').OGLRenderingContext & { canvas: HTMLCanvasElement };
