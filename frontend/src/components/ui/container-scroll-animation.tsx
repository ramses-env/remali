...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="h-[40rem] md:h-[68rem] flex items-center justify-center relative p-2 md:p-20"
      ref={containerRef}
    >
...
export const Card = ({
  ...
  return (
    ...
    >
      <div className="h-full w-full overflow-hidden rounded-2xl bg-zinc-100 dark:bg-zinc-900 md:rounded-2xl md:p-4">
        {children}
      </div>
    </motion.div>
  )
