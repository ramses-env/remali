...
const ES: Dict = {
  ...
  'sec.adeudos.title': 'Adeudos',
  'sec.adeudos.sub': 'Rentas con saldo pendiente: quién debe, cuánto y desde cuándo. Registra abonos hasta liquidar.',
  ...
  'sec.equipo.title': 'Equipo',
  'sec.equipo.sub': 'Quién entra al panel y con qué puesto. A quién le vendes o le rentas está en Clientes.',
  'sec.permisos.title': 'Permisos',
  'sec.permisos.sub': 'Qué puede hacer cada puesto dentro del panel. Se guarda por puesto, no por persona.',
  'sec.ventas.title': 'Ventas',
  'sec.ventas.sub': 'Historial de ventas de maquinaria y refacciones.',
  'sec.pedidos.title': 'Pedidos y apartados',
  'sec.pedidos.sub': 'Ventas con anticipo: registra abonos y entrega cuando se liquide o llegue la máquina.',
  'sec.caja.title': 'Caja',
  'sec.caja.sub': 'Punto de venta de refacciones: arma el ticket, cobra y entrega.',
  ...
  'sec.configuracion.sub': 'Tu cuenta, los datos del negocio y las reglas del mostrador.',
  // Barra superior
  'top.search': 'Buscar…',
...
const EN: Dict = {
  ...
  'sec.adeudos.title': 'Debts',
  'sec.adeudos.sub': 'Rentals with an outstanding balance: who owes, how much and since when. Log payments until settled.',
  ...
  'sec.equipo.title': 'Team',
  'sec.equipo.sub': 'Who gets into the panel and with which role. Who you sell or rent to lives in Clients.',
  'sec.permisos.title': 'Permissions',
  'sec.permisos.sub': 'What each role can do inside the panel. Saved per role, not per person.',
  'sec.ventas.title': 'Sales',
  'sec.ventas.sub': 'History of machinery and spare-part sales.',
  'sec.pedidos.title': 'Orders & layaways',
  'sec.pedidos.sub': 'Sales with a deposit: log payments and deliver once settled or the machine arrives.',
  'sec.caja.title': 'Register',
  'sec.caja.sub': 'Spare-parts point of sale: build the ticket, charge and hand off.',
  ...
  'sec.configuracion.sub': 'Your account, business details and counter rules.',
  'top.search': 'Search…',
